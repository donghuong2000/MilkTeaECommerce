 ...
 *   https://datatables.net/download/#bs4-4.1.1/dt-1.10.22/sb-1.0.0/sp-1.2.1
 *
 * Included libraries:
 *   Bootstrap 4 4.1.1, DataTables 1.10.22, SearchBuilder 1.0.0, SearchPanes 1.2.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4-4.1.1/dt-1.10.22/sb-1.0.0/sp-1.2.1",
