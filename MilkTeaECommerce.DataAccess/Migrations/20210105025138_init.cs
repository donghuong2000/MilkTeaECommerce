        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateExpired = table.Column<DateTime>(type: "date", nullable: true),
                    TimesUsed = table.Column<int>(nullable: true),
                    TimesUseLimit = table.Column<int>(nullable: true),
                    PercentDiscount = table.Column<int>(nullable: true),
                    MaxDiscount = table.Column<float>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shops__9CBCE319A2F8A378", x => x.ApplicationUserId);
                    table.ForeignKey(
                        name: "FK_SHOP_USER",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__45AFFE36615A770A", x => new { x.DiscountId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_CategoryDiscount_Category",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CategoryDiscount_Discount",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Delivery__1219B56A28A08CCD", x => new { x.DiscountId, x.DeliveryId });
                    table.ForeignKey(
                        name: "FK_DeliveryDiscount_Deliveries",
                        column: x => x.DeliveryId,
                        principalTable: "Deliveries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryDiscount_Discount",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    OrderHeaderId = table.Column<string>(maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductD__2F7FA1FAC61561F2", x => new { x.DiscountId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductDiscount_Discount",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryId = table.Column<string>(maxLength: 450, nullable: true),
                    Address = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Delivery__D3B9D36CF25242FD", x => x.OrderDetailId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryDiscount_DeliveryId",
                table: "DeliveryDiscount",
                column: "DeliveryId");

            migrationBuilder.CreateIndex(
                name: "UQ__Discount__A25C5AA78CED2B9A",
                table: "Discounts",
                column: "Code",
                unique: true);
